...
# Recent Changes
- **2025-11-10**: **News System v3.1 Individual Push Format** - Refactored digest push to send each news item as separate Telegram message instead of combined list. Each message includes: news number (e.g., "1/10"), score, Chinese title, 200-char summary, AI commentary, source, and hashtags. Implemented 500ms delay between messages for Telegram rate limit compliance. Enhanced error handling with per-message try/catch and detailed success/failure tracking.
