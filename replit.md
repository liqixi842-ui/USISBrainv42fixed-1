...
# Recent Changes
- **2025-11-10**: **News System v2.0 PRODUCTION RELEASE** - Finalized institutional-grade news system with individual message format. Each news includes: emoji indicator (⚡/🔥/📊 based on score), Chinese title, score badge, full Chinese summary, AI investment analysis (60-150 chars, GPT-4o generated), source credibility label, original link, and multi-tier hashtags. Features automated Top 10 digest push at fixed even hours (00:00, 02:00, 04:00, 06:00, 08:00, 10:00, 12:00, 14:00, 16:00, 18:00, 20:00, 22:00), Google Translate integration (EN/ES/DE→CN), and N8N-distributed architecture covering 18 premium sources (WSJ, Reuters, Bloomberg, FT, etc.) across 6 regions. System ready for production deployment.
- **2025-11-10**: **News System v3.0 Translation FIXED** - Replaced DeepL with Google Translate (FREE, no API key required). Translation now working perfectly using @vitalets/google-translate-api library. Verified translations: "Apple Unveils Breakthrough in AI Chip Technology" → "苹果在人工智能芯片技术方面取得突破". AI Commentary generation confirmed working (GPT-4o). System now fully operational with both translation and AI commentary.
...
## News System v2.0 Architecture (N8N-Distributed + Chinese Translation)
...
Scheduler (periodic)
  ↓ Even Hour Digest Push (Top 10 at 00:00, 02:00, 04:00, 06:00, 08:00, 10:00, 12:00, 14:00, 16:00, 18:00, 20:00, 22:00)
...
- **Content Enhancement Service** (`newsEnhancement.js`): Automated Google Translate translation (EN/ES/DE→CN) for non-Chinese sources (FREE, no API key required), plus GPT-4o AI commentary generation (30-50 char future impact predictions). Graceful fallback on API failures to preserve workflow continuity.
