...
# Recent Changes
- **2025-11-10**: **News System v3.2 Final Format DEPLOYED** - Finalized individual message format for digest push. Each news message includes: emoji indicator (⚡/🔥/📊 based on score), Chinese title, score badge, full Chinese summary, AI investment analysis (60-150 chars, GPT-4o generated), source credibility label, original link, and multi-tier hashtags. Messages use Markdown formatting similar to urgent news format. Confirmed 2-hour auto-push schedule working correctly (Top 10 news from past 12 hours, repeatable delivery). Push format optimized for sharing to investment groups.
