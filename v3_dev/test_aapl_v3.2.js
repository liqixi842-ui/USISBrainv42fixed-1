...
async function testAAPL() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║  Testing v3.2 Multi-Model Pipeline: AAPL                  ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
  ...
  try {
    ...
    // Save JSON
    const fs = require('fs');
    fs.writeFileSync('/tmp/AAPL_v3.2_report.json', JSON.stringify(report, null, 2));
    console.log('✅ v3.2 Multi-Model Pipeline test complete!');
    console.log('📁 Full JSON saved to: /tmp/AAPL_v3.2_report.json\n');
